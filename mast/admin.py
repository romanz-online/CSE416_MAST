...
from .models import Student, Major, Course, Required_Classes_for_Track, Classes_Taken_by_Student,\
    Student_Course_Schedule, Comment, Tracks_in_Major, Requirement_Semester, Semester
